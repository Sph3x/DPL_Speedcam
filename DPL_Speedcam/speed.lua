--[[------------------------------------------------------------------------
	...
	Radar/DPL 
	Created by Brock edit by sphex =]
...
local radar =
{
	shown = false,
	freeze = false,
	info = "~y~Initializing System...~w~321...~y~Loaded! ",
	info2 = "~y~Initializing System...~w~321...~y~Loaded! ",
	minSpeed = 5.0,
	maxSpeed = 75.0,
}
...
Citizen.CreateThread( function()
	...
	while true do
		...
		if IsControlJustPressed(1, 128) and IsPedInAnyPoliceVehicle(GetPlayerPed(-1)) then
			...
			if radar.shown then 
				radar.shown = false 
				radar.info = string.format("~y~Initializing System...~w~321...~y~Loaded! ")
				radar.info2 = string.format("~y~Initializing System...~w~321...~y~Loaded! ")
			else 
				radar.shown = true 
			end		
                Wait(75)
